  ...
  return (
    ...
    >
      ...
      <div className='w-[180px] h-[16px]'>
        <div className='rounded-[5px] border-[1px] flex items-center px-[5px] mr-[8px] leading-[14px] border-[#FFBB00] text-[14px] leading-[14px] w-[40px] h-[16px] bg-[#e0a502] backdrop-blur-md'></div>
      </div>
    </div>
  );
};

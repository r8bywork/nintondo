const Text = () => {
	return (
		<div className={"text-white flex flex-col items-center"}>
			<span className="bg-black text-center mb-8 font-inconsolata text-4xl font-bold leading-normal px-4 relative">
			...
			<span className="bg-black">
				cryptocurrencies and track them with{" "}
				<span className={"text-regal-blue"}>explorer</span>.
			</span>
		</div>
	);
};
